package com.feng.core.freemarker.extend;
...
import com.feng.common.utils.SpringContextUtil;
import com.feng.common.utils.StringUtils;
import com.feng.common.utils.PathUtil;
import com.feng.core.tags.APITemplateModel;
...
public class Ferrmarker {
	//HTML输出目录
	protected static String HTML_PATH = PathUtil.getHTMLPath();
	//FTL输入目录
	protected static String FTL_PATH = PathUtil.getFTLPath();
...
//		initMap.put("path", path);
	...
	public static void bakFile(String fileName){
		if(StringUtils.isBlank(fileName))
			return;
		File[] files = PathUtil.getFiles(HTML_PATH);
