package com.feng.core.shiro.session;
...
import com.feng.core.shiro.CustomShiroSessionDAO;
import com.feng.user.bo.UserOnlineBo;
...
public class CustomSessionManager {
	 ...
	 * session status 
	 */
	public static final String SESSION_STATUS ="feng-online-status";
	@Autowired
