package com.feng.core.shiro.cache;
...
import com.feng.common.utils.SerializeUtil;
import com.feng.core.shiro.session.CustomSessionManager;
import com.feng.core.shiro.session.SessionStatus;
import com.feng.core.shiro.session.ShiroSessionRepository;
/**
 * Session 管理
 *
 */
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "feng-shiro-demo-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*feng-shiro-demo-session:*";
