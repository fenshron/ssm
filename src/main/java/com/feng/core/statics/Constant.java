package com.feng.core.statics;

import java.util.Calendar;

import com.feng.common.utils.DateUtil;
import com.feng.core.config.IConfig;
...
public interface Constant {
	...
	final static String  EXECUTE_CHANGE_USER = "FENG_EXECUTE_CHANGE_USER";
}
